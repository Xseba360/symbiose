...
new Webos.Locale({
	...
	integerGroupsSeparator: ' ',
	decimalSeparator: ',',
	days: ['Niedziela', 'Poniedziałek', 'Wtorek', 'Środa', 'Czwartek', 'Piątek', 'Sobota'],	// daysAbbreviations: ['Nie.', 'Pn.', 'Wt.', 'Śr.', 'Czw.', 'Pi.', 'Sob.'],	months: ['Styczeń', 'Luty', 'Marzec', 'Kwiecień', 'Maj', 'Czerwiec', 'Lipiec', 'Sierpień', 'Wrzesień', 'Październik', 'Listopad', 'Grudzień'],
